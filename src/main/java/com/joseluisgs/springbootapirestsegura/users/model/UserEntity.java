...
@Entity
@EntityListeners(AuditingEntityListener.class) // Para temas de fechas y automatizaciones
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder

// Entidad para lmacenar usuarios
public class UserEntity implements UserDetails {
    ...
    /**
     * No vamos a gestionar la credeciales de cuentas. De hacerse, se tendría que dar
     * cuerpo a este método
     */
